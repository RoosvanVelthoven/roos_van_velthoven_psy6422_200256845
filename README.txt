...
roos_van_velthoven_psy6422_2021 = contains the below folders and .gitignore, Rhistory, R.profile, core_code.R (code to create the visualisations), index.html, index.pdf, index.Rmd, README.txt, renv.lock, roos_van_velthoven_psy6422_2021.Rproj and visualisation.gif (same gif as in the figs folder)
...
data = contains two folders (processed and raw) and my codebook
       processed = contains csv files that I saved during the creating of my visualisations (nba_final_df.csv contains the data needed for my visualisation, nba_relabelled.csv contains data of interest, for all seasons, with recoded variables and nba_2018_2015.csv contains data of interest, for solely season 2015-2018, with recoded variables)
